...
<%//1-agrego un request.getParameter("nombre de l dato que quiero traer desde el form ticket.html")
	...
	Connection cn = MySqlConexion.conectar(); //2-3-Genero la conexión con la base de datos, con el método conectar(), de la clase MySqlConexion.java (archivo que se copió  y pego en el punto 1º). Este nos hace la conexión con (conexión = DriverManager.getConnection(URL,  USEER, PASS), de la base de datos.
